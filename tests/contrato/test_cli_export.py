# ══════════════════════════════════════════════════════════════════════════════
#  tests/contrato/test_cli_export
#
...
class TestExportCLI:
    def test_export_creates_declared_csvs(self, tmp_path: Path) -> None:
        ...
        rc = main(["--no-log-file", "export", "--db", str(db_path), "--output-dir", str(out_dir)])
        assert rc == 0
