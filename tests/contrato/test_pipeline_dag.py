# ══════════════════════════════════════════════════════════════════════════════
#  tests/contrato/test_pipeline_dag
#
...
class TestEmoparseDAG:
    ...
    def test_emotions_pass2_optional(self) -> None:
        ...
        assert "emotions_pass2" not in EMOPARSE_DAG.transitive_deps("explode_emotions")
        assert "emotions_pass2" not in EMOPARSE_DAG.transitive_deps("characterizer")
