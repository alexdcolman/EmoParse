...
class LlamaCppBackend(LLMBackend):
    ...
    def generate(
        ...
        *,
        ...
        # insuficiente; no recuperable. El `prompt_tokens` real (de `usage`)
        # distingue las dos causas de un vistazo: si prompt ya casi llena el
        # context_length, hay que acortar el system; si sobra lugar, el techo
        # de completion es corto para la salida esperada.
