# ══════════════════════════════════════════════════════════════════════════════
#  emoparse.scraping.sources.casarosada
#
...
from emoparse.scraping.http_client import HttpClient
from emoparse.scraping.normalize import (
    clean_whitespace,
    normalize_date,
    normalize_url,
    strip_boilerplate,
...
class CasaRosadaAdapter(SourceAdapter):
    ...
    def _fetch_selenium(self, url: str) -> str:
        ...
        if self._selenium is None:
            from emoparse.scraping.selenium_client import SeleniumClient
